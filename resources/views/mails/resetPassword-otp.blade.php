...
<body>
    <div class="email-container">
        ...
        <div class="body">
            ...
            <p>Ini adalah kode OTP Anda untuk mengatur ulang password Anda:</p>
            <p class="otp-code">{{ $otp }}</p>
            <p>Kode ini berlaku selama 5 menit. Jika Anda tidak melakukan reset password, abaikan email ini.</p>
        </div>
        <div class="footer">
